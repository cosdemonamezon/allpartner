...
class PartnerLanguage extends StatefulWidget {
  PartnerLanguage({Key? key}) : super(key: key);

  @override
  State<PartnerLanguage> createState() => _PartnerLanguageState();
}

class _PartnerLanguageState extends State<PartnerLanguage> {
  bool langchang = true;
  @override
